...
# installed.
TCL_PREFIX='D:/projects_practice/creditcard_frauddetection/venv_credit\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/projects_practice/creditcard_frauddetection/venv_credit\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/projects_practice/creditcard_frauddetection/venv_credit\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/projects_practice/creditcard_frauddetection/venv_credit\Library\include'
...
TCL_PACKAGE_PATH='D:/projects_practice/creditcard_frauddetection/venv_credit\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/projects_practice/creditcard_frauddetection/venv_credit\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/projects_practice/creditcard_frauddetection/venv_credit\Library\lib\tclstub86.lib'
